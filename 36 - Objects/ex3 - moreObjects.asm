# Add several additional objects to the Complete Program of ass36_19.html. Modify
# the main program so that it exercises several of the methods of the objects.
...
main:					# object1.print();
	...
	jalr	$t0		#	call the object's method
				# object3.print();
	la	$a0, object3	#	get address of third object
	lw	$t0, 0($a0)	#	get address of object's method
	jalr	$t0		#	call the object's method
				# object4.cancel();
	la	$a0, object4	#	get address of fourth object
	lw	$t0, 4($a0)	#	get address of object's method
	jalr	$t0		#	call the object's method
				# object4.print();
	la	$a0, object4	#	get address of fourth object
	lw	$t0, 0($a0)	#	get address of object's method
